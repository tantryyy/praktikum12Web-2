...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/png/kucing(1).png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/png/anak anjing (2).jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/png/dua duanya.png" class="d-block w-100" alt="...">
    </div>
  </div>
